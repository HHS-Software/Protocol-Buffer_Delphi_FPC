...
## How to use?
- Add the file [ProtocolBuffer.pas](ProtocolBuffer.pas) to your project,
- Use the [protoc-pascal.exe](protoc-pascal/bin) utility to convert your .proto message files into .pas object files.  Add these to your project.
...
- Automatically allocates repeated (array) data types and nested array types.  Access these like so: `SampleProto.SomeIntArray[2] := 321; or SampleProto.NestedArray[3].x := 789;`
- Converts enum message types into pascal Enumeration types.
- Simple and easy.
- Can merge many message.proto files into one source.pas file.
